...
<div class="mb-4 p-3 bg-green-50 border border-green-200 rounded" style="margin-bottom: 15px;">
    ...
    <ul class="mt-2 text-sm" style="margin: 8px 0; padding-left: 20px;">
        ...
        if ( !empty( $available_licenses ) ) {
            ...
            <li style="color: #856404;">No licenses available to assign</li>
        <?php } ?>
    </ul>
</div>
            ...
            if (response.success && response.data && response.data.length > 0) {
                ...
                modalHTML += `
                    <div style="margin: 20px 0;">
                        <h3 style="font-size: 16px; margin-bottom: 10px;">Available Licenses (${licenseCount} total):</h3>
...
$('#bulk-assign-confirm-btn').off('click').on('click', function() {
    processBulkAssignment(selectedEmails, licenses.map(l => l.ID));
                ...
                alert('No licenses available for assignment.');
            }
        },
        error: function(xhr, status, error) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                $('#bulk-assign-confirm-btn').text('Assign Licenses');
            }
        },
        error: function(xhr, status, error) {
